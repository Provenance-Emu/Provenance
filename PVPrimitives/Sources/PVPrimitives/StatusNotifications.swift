...
public extension Notification.Name {
    ...
    /// Notification posted when iCloud account is not available
    static let iCloudSyncAccountNotAvailable = Notification.Name("iCloudSyncAccountNotAvailable")

    /// Notification posted when iCloud account is restricted
    static let iCloudSyncAccountRestricted = Notification.Name("iCloudSyncAccountRestricted")
}
