...
# For xcfilelists, repo convention is to omit headers entirely and emit only
# $(SRCROOT)/… path lines (with disabled entries commented as #$(SRCROOT)/…).
# Keep this empty so generate_xcfilelist does not introduce any header text.
XCFILELIST_HEADER = ""
