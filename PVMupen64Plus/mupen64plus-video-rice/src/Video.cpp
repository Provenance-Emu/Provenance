...
ptr_ConfigOpenSection      rice_ConfigOpenSection = NULL;
ptr_ConfigSetParameter     rice_ConfigSetParameter = NULL;
ptr_ConfigSetParameterHelp rice_ConfigSetParameterHelp = NULL;
ptr_ConfigGetParameter     rice_ConfigGetParameter = NULL;
ptr_ConfigGetParameterHelp rice_ConfigGetParameterHelp = NULL;
ptr_ConfigSetDefaultInt    rice_ConfigSetDefaultInt = NULL;
ptr_ConfigSetDefaultFloat  rice_ConfigSetDefaultFloat = NULL;
ptr_ConfigSetDefaultBool   rice_ConfigSetDefaultBool = NULL;
ptr_ConfigSetDefaultString rice_ConfigSetDefaultString = NULL;
ptr_ConfigGetParamInt      rice_ConfigGetParamInt = NULL;
ptr_ConfigGetParamFloat    rice_ConfigGetParamFloat = NULL;
ptr_ConfigGetParamBool     rice_ConfigGetParamBool = NULL;
ptr_ConfigGetParamString   rice_ConfigGetParamString = NULL;

ptr_ConfigGetSharedDataFilepath rice_ConfigGetSharedDataFilepath = NULL;
ptr_ConfigGetUserConfigPath     rice_ConfigGetUserConfigPath = NULL;
ptr_ConfigGetUserDataPath       rice_ConfigGetUserDataPath = NULL;
ptr_ConfigGetUserCachePath      rice_ConfigGetUserCachePath = NULL;
                                   ...
                                   void (*DebugCallback)(void *, int, const char *))
{
    ...
    DebugMessage(M64MSG_ERROR, "Called PluginStartup on RICE plugin");
    ...
    {
        DebugMessage(M64MSG_ERROR, "RICE: Core emulator broken; no CoreAPIVersionFunc() function found.");
    ...
    rice_ConfigOpenSection = (ptr_ConfigOpenSection) osal_dynlib_getproc(CoreLibHandle, "ConfigOpenSection");
    rice_ConfigSetParameter = (ptr_ConfigSetParameter) osal_dynlib_getproc(CoreLibHandle, "ConfigSetParameter");
    rice_ConfigSetParameterHelp = (ptr_ConfigSetParameterHelp) osal_dynlib_getproc(CoreLibHandle, "ConfigSetParameterHelp");
    rice_ConfigGetParameter = (ptr_ConfigGetParameter) osal_dynlib_getproc(CoreLibHandle, "ConfigGetParameter");
    rice_ConfigSetDefaultInt = (ptr_ConfigSetDefaultInt) osal_dynlib_getproc(CoreLibHandle, "ConfigSetDefaultInt");
    rice_ConfigSetDefaultFloat = (ptr_ConfigSetDefaultFloat) osal_dynlib_getproc(CoreLibHandle, "ConfigSetDefaultFloat");
    rice_ConfigSetDefaultBool = (ptr_ConfigSetDefaultBool) osal_dynlib_getproc(CoreLibHandle, "ConfigSetDefaultBool");
    rice_ConfigSetDefaultString = (ptr_ConfigSetDefaultString) osal_dynlib_getproc(CoreLibHandle, "ConfigSetDefaultString");
    rice_ConfigGetParamInt = (ptr_ConfigGetParamInt) osal_dynlib_getproc(CoreLibHandle, "ConfigGetParamInt");
    rice_ConfigGetParamFloat = (ptr_ConfigGetParamFloat) osal_dynlib_getproc(CoreLibHandle, "ConfigGetParamFloat");
    rice_ConfigGetParamBool = (ptr_ConfigGetParamBool) osal_dynlib_getproc(CoreLibHandle, "ConfigGetParamBool");
    rice_ConfigGetParamString = (ptr_ConfigGetParamString) osal_dynlib_getproc(CoreLibHandle, "ConfigGetParamString");

    rice_ConfigGetSharedDataFilepath = (ptr_ConfigGetSharedDataFilepath) osal_dynlib_getproc(CoreLibHandle, "ConfigGetSharedDataFilepath");
    rice_ConfigGetUserConfigPath = (ptr_ConfigGetUserConfigPath) osal_dynlib_getproc(CoreLibHandle, "ConfigGetUserConfigPath");
    rice_ConfigGetUserDataPath = (ptr_ConfigGetUserDataPath) osal_dynlib_getproc(CoreLibHandle, "ConfigGetUserDataPath");
    rice_ConfigGetUserCachePath = (ptr_ConfigGetUserCachePath) osal_dynlib_getproc(CoreLibHandle, "ConfigGetUserCachePath");

    if (!rice_ConfigOpenSection || !rice_ConfigSetParameter || !rice_ConfigSetParameterHelp || !rice_ConfigGetParameter ||
        !rice_ConfigSetDefaultInt || !rice_ConfigSetDefaultFloat || !rice_ConfigSetDefaultBool || !rice_ConfigSetDefaultString ||
        !rice_ConfigGetParamInt   || !rice_ConfigGetParamFloat   || !rice_ConfigGetParamBool   || !rice_ConfigGetParamString ||
        !rice_ConfigGetSharedDataFilepath || !rice_ConfigGetUserConfigPath || !rice_ConfigGetUserDataPath || !rice_ConfigGetUserCachePath)
    {
