...
- **Fine-grained SNES Mouse movement** — Mouse input uses sub-pixel accumulation to preserve small movement deltas across frames for smoother, more accurate cursor motion.
