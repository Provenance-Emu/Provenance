...
- **`PVEmulatorViewController+CompanionController`** — PVUI extension that detects `CompanionControllerCapable` cores, subscribes to the companion input router via Combine, and forwards trackball deltas and button edge events to the core each frame
