...
### Changed
- **Portrait controller scaling** — Portrait controls are laid out at size ÷ scale and scaled to fill the allocated controller area, so they grow or shrink with the setting without clipping
