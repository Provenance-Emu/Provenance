...
- **Pause menu MIDI picker** — shows "Multiple (N)" instead of "None" when more than one MIDI source or destination is configured via the Quick Settings multi-select picker
