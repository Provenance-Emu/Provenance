### Fixed
- **iCadeState button collision** — `buttonI` and `buttonJ` shared the same rawValue (`1 << 13`), causing Mocute trigger inputs to be indistinguishable. Each bit flag is now unique.
