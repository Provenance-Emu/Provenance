...
- **DualSense adaptive triggers wired** — `dualSenseAdaptiveTriggersEnabled` toggle now actively applies/removes trigger resistance on connected DualSense controllers; PlayStation systems default to `.soft` feedback on L2/R2
