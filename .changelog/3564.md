...
- **`_systemSpecificDirectory` uses an NSDictionary mapping** — The ObjC system→directory-name table mirrors `SystemIdentifier.systemDirectoryName` in `PVPrimitives`; both must be updated when adding new systems.
