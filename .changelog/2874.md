...
### Changed
- **Game library section headers** — `textAlignment` changed from hardcoded `.left` to an explicit `effectiveUserInterfaceLayoutDirection` check so headers right-align in RTL locales (Arabic, Hebrew).
