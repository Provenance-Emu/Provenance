### Added
- **SharedCheatStore** — Actor-backed persistent store that reads/writes cheat codes to the `group.org.provenance-emu.provenance` App Group container, enabling cheat sharing between the main Provenance app, companion app, and extensions.
...
- **Cheat Library IAP** — New StoreKit 2 product `org.provenance-emu.companion.iap.cheat-library` added to the companion app product catalogue.
