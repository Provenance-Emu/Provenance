...
- **SMS Pause/NMI button** — Sega Master System now shows a PAUSE momentary button in the hardware overlay. Pressing it sends the Z80 NMI signal (mapped to `start` button ID) as a momentary edge, matching the physical console Pause button behavior.
