...
bool _TPCircularBufferInit(TPCircularBuffer *buffer, BufferSize length, size_t structSize);
 ...
 */
static __inline__ __attribute__((always_inline)) void* TPCircularBufferTail(TPCircularBuffer *buffer, BufferSize* availableBytes) {
 ...
 */
static __inline__ __attribute__((always_inline)) void* TPCircularBufferHead(TPCircularBuffer *buffer, BufferSize* availableBytes) {
 ...
 */
static __inline__ __attribute__((always_inline)) bool TPCircularBufferProduceBytes(TPCircularBuffer *buffer, const void* src, BufferSize len) {
    BufferSize space;
