//
//  PVCDiControllerViewController.swift
//  Provenance
//
...
private extension JSButton {
    var buttonTag: PVCDiButton {
        get {
            return PVCDiButton(rawValue: tag) ?? .count
        }
        set {
...
final class PVCDiControllerViewController: PVControllerViewController<PVCDiSystemResponderClient> {
