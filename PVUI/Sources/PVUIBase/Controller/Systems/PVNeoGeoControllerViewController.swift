//  PVNeoGeoControllerViewController.swift
//  Provenance
//
...
private extension JSButton {
    var buttonTag: PVNeoGeoButton {
        get {
            guard let mapped = PVNeoGeoButton(rawValue: tag) else {
                ...
                ELOG("Neo GeoController: unknown JSButton tag \(tag) — defaulting to .up (likely an auxiliary button, not an emulator input)")
                return .up
            }
            return mapped
        }
...
final class PVNeoGeoControllerViewController: PVControllerViewController<PVNeoGeoSystemResponderClient> {
