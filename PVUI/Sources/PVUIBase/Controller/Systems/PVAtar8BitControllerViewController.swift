...
private extension JSButton {
    var buttonTag: PVA8Button {
        get {
            guard let mapped = PVA8Button(rawValue: tag) else {
                ...
                ELOG("Atari 8-bitController: unknown JSButton tag \(tag) — defaulting to .up (likely an auxiliary button, not an emulator input)")
                return .up
            }
            return mapped
        }
...
final class PVAtari8BitControllerViewController: PVControllerViewController<PVA8SystemResponderClient> {
