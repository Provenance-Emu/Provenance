...
extension PVSaveState: SubCellItem {
    ...
    static func registerCell(in collectionView: UICollectionView) {
        #if os(tvOS)
            collectionView.register(UINib(nibName: "PVSaveStateCollectionViewCell~tvOS", bundle: BundleLoader.module), forCellWithReuseIdentifier: Self.identifier)
        #else
            collectionView.register(UINib(nibName: "PVSaveStateCollectionViewCell", bundle: BundleLoader.module), forCellWithReuseIdentifier: Self.identifier)
        #endif
    }
}
