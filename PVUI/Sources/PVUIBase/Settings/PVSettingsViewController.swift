    ...
    func generateTableViewViewModels() {
        ...
        avRows.append(contentsOf: [
            ...
            PVSettingsSwitchRow(text: NSLocalizedString("4X Multisampling GL", comment: "4X Multisampling GL"),
                                ...
                                key: .multiSampling,
                                icon: .sfSymbol("4k.tv")),
            PVSettingsSegmentedRow(text: NSLocalizedString("Scaling Mode", comment: "Scaling Mode"),
                                   detailText: .subtitle(Defaults[.scalingMode].subtitle),
                                   key: .scalingMode,
                                   icon: .sfSymbol(Defaults[.scalingMode].symbolName),
                                   viewController: self),
