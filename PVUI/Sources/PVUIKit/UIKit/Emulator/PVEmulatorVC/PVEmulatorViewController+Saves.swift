...
extension PVEmulatorViewController {
    var saveStatePath: URL { get async { await PVEmulatorConfiguration.saveStatePath(forGame: game) } }
...
extension PVEmulatorViewController {
    ...
    func convertOldSaveStatesToNewIfNeeded() async {
