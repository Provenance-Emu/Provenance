...
//                    Defaults[.theme] = palette
        ...
        var saveRows: [TableRow] = [
            PVSettingsSwitchRow(text: NSLocalizedString("Auto Save", comment: "Auto Save"), detailText: .subtitle("Auto-save game state on close. Must be playing for 30 seconds more."), key: Defaults[.autoSave], icon: .sfSymbol("autostartstop")),
            PVSettingsSwitchRow(text: NSLocalizedString("Timed Auto Saves", comment: "Timed Auto Saves"), detailText: .subtitle("Periodically create save states while you play."), key: Defaults[.timedAutoSaves], icon: .sfSymbol("clock.badge")),
            PVSettingsSwitchRow(text: NSLocalizedString("Auto Load Saves", comment: "Auto Load Saves"), detailText: .subtitle("Automatically load the last save of a game if one exists. Disables the load prompt."), key: Defaults[.autoLoadSaves], icon: .sfSymbol("autostartstop.trianglebadge.exclamationmark")),
            PVSettingsSwitchRow(text: NSLocalizedString("Ask to Load Saves", comment: "Ask to Load Saves"), detailText: .subtitle("Prompt to load last save if one exists. Off always boots from BIOS unless auto load saves is active."), key: Defaults[.askToAutoLoad], icon: .sfSymbol("autostartstop.trianglebadge.exclamationmark"))
        ]
#if os(iOS)
        ...
        #if os(iOS)
            avRows.append(contentsOf: [PVSettingsSwitchRow(text: NSLocalizedString("Volume HUD", comment: "Volume HUD"), key: Defaults[.volumeHUD], icon: .sfSymbol("speaker.square"))])
        ...
        avRows.append(contentsOf: [
            PVSettingsSwitchRow(text: NSLocalizedString("Multi-threaded GL", comment: "Multi-threaded GL"),
                                ...
                                key: Defaults[.multiThreadedGL], icon: .sfSymbol("rectangle.split.3x3")),
            PVSettingsSwitchRow(text: NSLocalizedString("4X Multisampling GL", comment: "4X Multisampling GL"),
                                ...
                                key: Defaults[.multiSampling], icon: .sfSymbol("4k.tv")),
            PVSettingsSwitchRow(text: NSLocalizedString("Native Scale", comment: "Native Scale"), detailText: .subtitle("Scale up to fit native screen resolution."), key: Defaults[.nativeScaleEnabled], icon: .sfSymbol("square.split.bottomrightquarter")),
            PVSettingsSwitchRow(text: NSLocalizedString("Integer Scaling", comment: "Integer Scaling"), detailText: .subtitle("Lock scaling to integer values. Sharper but may result in blank space depending on the original aspect ratio."), key: Defaults[.integerScaleEnabled], icon: .sfSymbol("lock.square")),
            PVSettingsSwitchRow(text: NSLocalizedString("CRT Filter", comment: "CRT Filter"), detailText: .subtitle("Apply a fast FX filter in the style of old CRT TV with curvature, bloom and scanlines."), key: Defaults[.crtFilterEnabled], icon: .sfSymbol("sparkles.tv")),
            PVSettingsSwitchRow(text: NSLocalizedString("LCD Filter", comment: "LCD Filter"), detailText: .subtitle("Use CRT filter on LCD (mobile) screens. LCD filter coming."), key: Defaults[.lcdFilterEnabled], icon: .sfSymbol("square.grid.3x3")),
            PVSettingsSwitchRow(text: NSLocalizedString("Image Smoothing", comment: "Image Smoothing"), detailText: .subtitle("Apply native iOS global image anti-aliasing smoothing filter to all emus."), key: Defaults[.imageSmoothing], icon: .sfSymbol("checkerboard.rectangle")),
            PVSettingsSwitchRow(text: NSLocalizedString("FPS Counter", comment: "FPS Counter"), detailText: .subtitle("Performance overlay with FPS, CPU and Memory stats. Note: FPS may not be accurate for threaded and/or GLES/Vulkan native cores."), key: Defaults[.showFPSCount], icon: .sfSymbol("speedometer"))
        ])
        ...
        #if os(iOS)
        controllerRows.append(PVSettingsSliderRow(text: NSLocalizedString("Opacity", comment: "Opacity"), detailText: .subtitle("Transparency amount of on-screen controls overlays."), valueLimits: (min: 0.0, max: 1.0), valueImages: (.sfSymbol("sun.min"), .sfSymbol("sun.max")), key: Defaults[.controllerOpacity]))

            controllerRows.append(contentsOf: [
                PVSettingsSwitchRow(text: NSLocalizedString("Button Colors", comment: "Button Colors"), detailText: .subtitle("Color the on-screen controls to be similar to their original system controller colors where applicable."), key: Defaults[.buttonTints], icon: .sfSymbol("paintpalette")),
                PVSettingsSwitchRow(text: NSLocalizedString("All-Right Shoulders", comment: "All-Right Shoulders"), detailText: .subtitle("Moves L1, L2 & Z to right side"), key: Defaults[.allRightShoulders], icon: .sfSymbol("l.joystick.tilt.right")),
                PVSettingsSwitchRow(text: NSLocalizedString("Haptic Feedback", comment: "Haptic Feedback"), detailText: .subtitle("Vibrate on button push and force feedback on iPhone and controllers where applicable."), key: Defaults[.buttonVibration], icon: .sfSymbol("hand.point.up.braille")),
                PVSettingsSwitchRow(text: NSLocalizedString("Enable 8BitDo M30 Mapping", comment: "Enable 8BitDo M30 Mapping"), detailText: .subtitle("For use with Sega Genesis/Mega Drive, Sega/Mega CD, 32X, Saturn and the PC Engine."), key: Defaults[.use8BitdoM30], icon: .sfSymbol("arrow.triangle.swap")),
                PVSettingsSwitchRow(text: NSLocalizedString("Missing Buttons Always On-Screen", comment: "Missing Buttons Always On-Screen"),
                                    ...
                                    key: Defaults[.missingButtonsAlwaysOn],
        ...
        let appStoreRows: [TableRow] = [
            ...
            PVSettingsSwitchRow(text: NSLocalizedString("Use Swift UI", comment: "Use Swift UI"),
                                ...
                                key: Defaults[.useSwiftUI], icon: .sfSymbol("swift")) { cell, row in
            ...
            PVSettingsSwitchRow(text: NSLocalizedString("Auto JIT", comment: "Auto JIT"),
                                ...
                                key: Defaults[.autoJIT], icon: .sfSymbol("figure.run")),
            ...
            PVSettingsSwitchRow(text: NSLocalizedString("Unsupported Cores", comment: "Unsupported Cores"),
                                ...
                                key: Defaults[.unsupportedCores], icon: .sfSymbol("testtube.2"))
            ]
         ...
         let betaRows: [TableRow] = [
            PVSettingsSwitchRow(text: NSLocalizedString("Use Metal", comment: "Use Metal"), detailText: .subtitle("Use experimental Metal backend instead of OpenGL. Some cores may experience color or size issues with this mode."),
                                key: Defaults[.useMetal], icon: .sfSymbol("testtube.2")),
            PVSettingsSwitchRow(text: NSLocalizedString("iCloud Sync", comment: "iCloud Sync"),
                                detailText: .subtitle("Sync core & battery saves, screenshots and BIOS's to iCloud."),
                                key: Defaults[.iCloudSync], icon: .sfSymbol("icloud")),
