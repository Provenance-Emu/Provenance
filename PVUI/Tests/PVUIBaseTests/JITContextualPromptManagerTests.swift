...
struct JITContextualPromptManagerTests {
    ...
    func nonJITCoreReturnsProceeed() {
    ...
    func requiredCoreIgnoresSkipJITPreference() {
        ...
        defer { clearPreference(forMD5: "ps2md5") }
    ...
    func requiredCoreShowsBlockingWarning() {
        clearPreference(forMD5: "ps2md5_auto")
        defer { clearPreference(forMD5: "ps2md5_auto") }
    ...
    func skipJITPreferenceReturnsSkipJIT() {
        ...
        defer { clearPreference(forMD5: "n64md5") }
    ...
    func preferJITAlwaysPrompts() {
        ...
        defer { clearPreference(forMD5: "n64md5_prefer") }
    ...
    func automaticShowsOncePerSession() {
        clearPreference(forMD5: "psp_auto")
        defer { clearPreference(forMD5: "psp_auto") }
    ...
    func resetSessionStateRestoresPrompt() {
        clearPreference(forMD5: "psp_reset")
        defer { clearPreference(forMD5: "psp_reset") }
