...
class PatronsHeaderView: UICollectionReusableView
{
    ...
    override init(frame: CGRect)
    {
        ...
        // Make constraints of top:0, left:20, bottom:0, right:20
        textLabel.addConstraints([
            .init(item: self.textLabel, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1, constant: 0),
            .init(item: self.textLabel, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: 0),
            .init(item: self.textLabel, attribute: .left, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: 20),
            .init(item: self.textLabel, attribute: .right, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1, constant: -20)
        ])
    }
...
#warning("TODO: Add an activity indicator")
