...
@objc public enum PVJaguarButton: Int, EmulatorCoreButton {
    ...
    public init(_ value: String) {
        ...
        case "1", "button1" : self = .button1
        case "2", "button2" : self = .button2
        case "3", "button3" : self = .button3
        case "4", "button4" : self = .button4
        case "5", "button5" : self = .button5
        case "6", "button6" : self = .button6
        case "7", "button7" : self = .button7
        case "8", "button8" : self = .button8
        case "9", "button9" : self = .button9
