...
public let PVEmulatorCoreErrorDomain = "org.provenance-emu.EmulatorCore.ErrorDomain"
public var PVEmulatorCoreClass: AnyClass?
...
public final class CoreError: NSObject {
    ...
    @objc
    static public var PVEmulatorCoreClass: AnyClass?
}
