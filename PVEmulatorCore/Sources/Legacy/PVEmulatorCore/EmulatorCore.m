...
@implementation PVEmulatorCore (Rumble)
...
@implementation PVEmulatorCore (Runloop)
...
@implementation PVEmulatorCore (Controllers)
...
@implementation PVEmulatorCore (Saves)
...
@implementation PVEmulatorCore (Video)
...
@implementation PVEmulatorCore (Audio)
