...
public struct CGABlueThemePalette: UXThemePalette, Codable, Sendable, Hashable {
    ...
    public var gameLibraryBackground: UIColor { .CGA.blueShadow.brightness(backgroundBritness) }
...
public struct CGAPurpleThemePalette: UXThemePalette, Codable, Sendable, Hashable {
    ...
    public var gameLibraryBackground: UIColor { .CGA.purpleShadow.brightness(backgroundBritness) }
    ...
    public var settingsHeaderBackground: UIColor? { .CGA.purpleShadow.brightness(backgroundBritness) }
    public var settingsHeaderText: UIColor? { .CGA.purple }

    public var settingsCellBackground: UIColor? { .CGA.purpleShadow.brightness(backgroundBritness) }
...
public struct CGAYellowThemePalette: UXThemePalette, Codable, Sendable, Hashable {
    ...
    public var gameLibraryBackground: UIColor { .CGA.yellowShadow.brightness(backgroundBritness) }
