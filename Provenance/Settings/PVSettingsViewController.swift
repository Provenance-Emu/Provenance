...
final class PVSettingsViewController: QuickTableViewController {
    ...
    func generateTableViewViewModels() {
        ...
        avRows.append(contentsOf: [
            ...
            PVSettingsSwitchRow(text: NSLocalizedString("Image Smoothing", comment: "Image Smoothing"), detailText: .subtitle("Apply native iOS global image anti-aliasing smoothing filter to all emus."), key: \PVSettingsModel.imageSmoothing, icon: .sfSymbol("checkerboard.rectangle")),
