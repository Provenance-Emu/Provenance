...
public extension PVBundleFinder {
    static var PVFCEUEmulatorCoreModule: Bundle { Bundle.module }
    static var PVFCEUEmulatorCoreBundle: Bundle { Bundle(for: PVFCEUEmulatorCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVFCEUEmulatorCoreBundle: Bundle { Bundle(for: PVFCEUEmulatorCore.self) }
...
@objc
extension PVFCEUEmulatorCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVFCEUEmulatorCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVFCEUEmulatorCoreBundle }
