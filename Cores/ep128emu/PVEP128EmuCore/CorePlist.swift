...
public extension PVBundleFinder {
    static var EP128Module: Bundle { Bundle.module }
    static var EP128Bundle: Bundle { Bundle(for: PVEP128EmuCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVEP128CoreBundle: Bundle { Bundle(for: PVEP128EmuCore.self) }
}
#endif

@objc
extension PVEP128EmuCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVEP128CoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVEP128CoreBundle }
