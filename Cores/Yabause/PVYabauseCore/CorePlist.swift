...
public extension PVBundleFinder {
    static var YabauseModule: Bundle { Bundle.module }
    static var YabauseBundle: Bundle { Bundle(for: PVYabauseCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVYabauseCoreBundle: Bundle { Bundle(for: PVYabauseCore.self) }
}
#endif

@objc
extension PVYabauseCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVYabauseCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVYabauseCoreBundle }
