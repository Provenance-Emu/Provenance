...
public extension PVBundleFinder {
    static var FlycastModule: Bundle { Bundle.module }
    static var FlycastBundle: Bundle { Bundle(for: PVFlycastEmuCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVFlycastCoreBundle: Bundle { Bundle(for: PVFlycastEmuCore.self) }
}
#endif

@objc
extension PVFlycastEmuCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVFlycastCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVFlycastCoreBundle }
