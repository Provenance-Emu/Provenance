...
public extension PVBundleFinder {
    static var FuseModule: Bundle { Bundle.module }
    static var FuseBundle: Bundle { Bundle(for: PVFuseEmuCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVFuseCoreBundle: Bundle { Bundle(for: PVFuseEmuCore.self) }
}
#endif

@objc
extension PVFuseEmuCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVFuseCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVFuseCoreBundle }
