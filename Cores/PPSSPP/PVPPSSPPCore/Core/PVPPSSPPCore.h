...
#pragma clang diagnostic pop
	...
	BOOL vertexCache;
	BOOL lazyTextureCaching;
	BOOL separateSASThread;
	BOOL preloadFunctions;
...
@property (nonatomic, assign) bool hardwareTransform;
@property (nonatomic, assign) bool softwareSkinning;
@property (nonatomic, assign) bool vertexCache;
@property (nonatomic, assign) bool lazyTextureCaching;
@property (nonatomic, assign) bool separateSASThread;
@property (nonatomic, assign) bool preloadFunctions;
@property (nonatomic, assign) bool cacheFullIsoInRam;
