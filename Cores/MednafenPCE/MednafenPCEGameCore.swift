...
extension MednafenPCEGameCore: DiscSwappable {
...
extension MednafenPCEGameCore: CoreActions {
...
extension MednafenPCEGameCore: GameWithCheat {
...
extension MednafenPCEGameCore: CoreOptional {
...
@objc public extension MednafenPCEGameCore {
    @objc(video_blit_timesync) var video_blit_timesync: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.video_blit_timesync).asBool }
    @objc(video_fs) var video_fs: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.video_fs).asBool }
    
    @objc(mednafen_pceFast) var mednafen_pceFast: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.pceFastOption).asBool }
    @objc(mednafen_snesFast) var mednafen_snesFast: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.snesFastOption).asBool }

    @objc(mednafen_snesFast_spex) var mednafen_snesFast_spex: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.snesFastSpexOption).asBool }
        
    @objc(psx_h_overscan) var psx_h_overscan: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.psx_h_overscan).asBool }

    @objc(vb_instant_display_hack) var vb_instant_display_hack: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.vb_instant_display_hack).asBool }
    
    @objc(vb_sidebyside) var vb_sidebyside: Bool { MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.vb_sidebyside).asBool }
    ...
    func parseOptions() {
        self.video_opengl = MednafenPCEGameCore.valueForOption(MednafenPCEGameCore.video_openglOption).asBool;
    }
}
