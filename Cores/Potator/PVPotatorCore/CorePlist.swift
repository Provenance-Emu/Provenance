...
public extension PVBundleFinder {
    static var PotatorModule: Bundle { Bundle.module }
    static var PotatorBundle: Bundle { Bundle(for: PVPotatorCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVPotatorCoreBundle: Bundle { Bundle(for: PVPotatorCore.self) }
}
#endif

@objc
extension PVPotatorCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVPotatorCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVPotatorCoreBundle }
