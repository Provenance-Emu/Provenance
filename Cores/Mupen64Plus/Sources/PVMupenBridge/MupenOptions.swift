...
@objc
public final class MupenGameCoreOptions: NSObject, CoreOptions, CoreOptional, Sendable {
    ...
    static var dualJoystick: CoreOption {
        .bool(.init(
    ...
    public static var options: [CoreOption] {
        ...
        // MARK: -- Controls
        let controlOptions: [CoreOption] = [dualJoystick, controllerPak1, controllerPak2, controllerPak3, controllerPak4]
...
@objc
extension MupenGameCoreOptions {
