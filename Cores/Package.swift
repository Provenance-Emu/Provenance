...
let package = Package(
    ...
    products: [
        .library(
            name: "ProvenanceCores",
            targets: ["ProvenanceCores"]
        ),
        .library(
            name: "ProvenanceCores-Static",
            type: .static,
            targets: ["ProvenanceCores"]
        ),
        .library(
            name: "ProvenanceCores-Dynamic",
            type: .dynamic,
            targets: ["ProvenanceCores"]
        ),
    ],
    ...
    targets: [
        ...
        .plugin(
            name: "CMakeGeneratorPlugin",
            capability: .buildTool(),
            dependencies: ["CMakeGenerator"]
        ),

        // .testTarget(
        //     name: "ProvenanceCoresTests",
        //     dependencies: ["ProvenanceCores"]
        // ),
    ],
