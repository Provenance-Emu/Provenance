...
public extension PVBundleFinder {
    static var mGBAModule: Bundle { Bundle.module }
    static var mGBABundle: Bundle { Bundle(for: PVmGBACore.self) }
}
#else
public extension PVBundleFinder {
    static public var mGBABundle: Bundle { Bundle(for: PVmGBACore.self) }
}
#endif

@objc
extension PVmGBACore: EmulatorCoreInfoPlistProvider {
