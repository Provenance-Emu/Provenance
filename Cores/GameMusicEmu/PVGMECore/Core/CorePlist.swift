...
public extension PVBundleFinder {
    static var GMEModule: Bundle { Bundle.module }
    static var GMEBundle: Bundle { Bundle(for: PVGMECore.self) }
}
#else
public extension PVBundleFinder {
    static var PVGMECoreBundle: Bundle { Bundle(for: PVGMECore.self) }
}
#endif

@objc
extension PVGMECore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVGMECoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVGMECoreBundle }
