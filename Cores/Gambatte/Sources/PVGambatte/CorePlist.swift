...
public extension PVBundleFinder {
    static var PVGambatteCoreModule: Bundle { Bundle.module }
    static var PVGambatteCoreBundle: Bundle { Bundle(for: PVGBEmulatorCore.self) }
}
#else
public extension PVBundleFinder {
    static public var PVGambatteCoreBundle: Bundle { Bundle(for: PVGBEmulatorCore.self) }
}
#endif

@objc
extension PVGBEmulatorCore: EmulatorCoreInfoPlistProvider {
