...
public extension PVBundleFinder {
    static var VecXModule: Bundle { Bundle.module }
    static var VecXBundle: Bundle { Bundle(for: PVVecXCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVVecXCoreBundle: Bundle { Bundle(for: PVVecXCore.self) }
}
#endif

@objc
extension PVVecXCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVVecXCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVVecXCoreBundle }
