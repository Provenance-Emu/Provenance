...
public extension PVBundleFinder {
    static var PicodriveGameCoreModule: Bundle { Bundle.module }
    static var PicodriveGameCoreBundle: Bundle { Bundle(for: PVPicoDrive.self) }
}
#else
public extension PVBundleFinder {
    static public var PicodriveGameCoreBundle: Bundle { Bundle(for: PVPicoDrive.self) }
}
#endif

extension PVPicoDrive: EmulatorCoreInfoPlistProvider {
