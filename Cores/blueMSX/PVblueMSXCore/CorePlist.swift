...
public extension PVBundleFinder {
    static var blueMSXModule: Bundle { Bundle.module }
    static var blueMSXBundle: Bundle { Bundle(for: PVblueMSXEmuCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVblueMSXCoreBundle: Bundle { Bundle(for: PVblueMSXEmuCore.self) }
}
#endif

@objc
extension PVblueMSXEmuCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVblueMSXCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVblueMSXCoreBundle }
