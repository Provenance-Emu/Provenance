//  PVAzaharCoreBridge.m
//  Copyright © 2023 Provenance. All rights reserved.

#import "PVAzaharCoreBridge+Controls.h"
...
__weak PVAzaharCoreBridge *_current = 0;
bool _isInitialized;
...
#pragma mark - PVAzaharCoreBridge Begin
...
- (void)setupEmulation {
    ...
    NSString* saveDirectory = [self.batterySavesPath stringByAppendingPathComponent:@"../AzaharData" ];
}
...
- (void)setupView {
    if (self.touchViewController) {
        ...
        m_view_controller=[[AzaharVulkanViewController alloc]
        ...
        {
            AzaharVulkanViewController *cgsh_view_controller=[[AzaharVulkanViewController alloc]
                                                                initWithResFactor:self.resFactor
                                                                videoWidth: self.videoWidth
                                                                videoHeight: self.videoHeight
                                                                core: self];
            ...
            AzaharOGLViewController *cgsh_view_controller=[[AzaharOGLViewController alloc]
                                                             initWithResFactor:self.resFactor
                                                             videoWidth: self.videoWidth
                                                             videoHeight: self.videoHeight
                                                             core: self];
