...
public extension PVBundleFinder {
    static var AzaharCoreModule: Bundle { Bundle.module }
    static var AzaharCoreBundle: Bundle { Bundle(for: PVAzaharCore.self) }
}
#else
public extension PVBundleFinder {
    static var AzaharCoreModule: Bundle { Bundle(for: PVAzaharCore.self) }
}
#endif

@objc
extension PVAzaharCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.AzaharCoreModule }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.AzaharCoreModule }
