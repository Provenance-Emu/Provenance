...
cmake ../citra -G Xcode -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=../citra/CMakeModules/ios.toolchain.cmake -DENABLE_BITCODE=NO -DPLATFORM=OS64COMBINED -DDEPLOYMENT_TARGET="13.0" -DPLATFORM_DEPLOYMENT_TARGET=13 -DENABLE_ANALYTICS=NO -DTARGET_IOS=ON -DCMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY="iPhone Developer" -DCMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM="XXXXXXXXXX" -DCMAKE_XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER="iOS Team Provisioning Profile: *"
#-DENABLE_BITCODE=NO -DPLATFORM=OS64COMBINED -DDEPLOYMENT_TARGET="13.0" -DPLATFORM_DEPLOYMENT_TARGET=13 -DENABLE_ANALYTICS=NO -DTARGET_IOS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY="iPhone Developer" -DCMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM="XXXXXXXXXX" -DCMAKE_XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER="iOS Team Provisioning Profile: *"
#-DCMAKE_OSX_ARCHITECTURES="x86_64;x86_64h"