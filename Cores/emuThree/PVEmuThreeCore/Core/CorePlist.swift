...
public extension PVBundleFinder {
    static var EmuThreeCoreModule: Bundle { Bundle.module }
    static var EmuThreeCoreBundle: Bundle { Bundle(for: PVEmuThreeCore.self) }
}
#else
public extension PVBundleFinder {
    static var EmuThreeCoreModule: Bundle { Bundle(for: PVEmuThreeCore.self) }
}
#endif

@objc
extension PVEmuThreeCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.EmuThreeCoreModule }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.EmuThreeCoreModule }
    ...
    public static var corePlistFromBundle: EmulatorCoreInfoPlist {
        ...
        let options: PropertyListSerialization.ReadOptions = 0
        guard let plistObject = try? PropertyListSerialization.propertyList(from: data, options: options, format: nil) as? [String: Any] else {
