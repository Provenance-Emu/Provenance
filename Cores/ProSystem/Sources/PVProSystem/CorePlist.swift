...
public extension PVBundleFinder {
    static var PVProSystemModule: Bundle { Bundle.module }
    static var PVProSystemBundle: Bundle { Bundle(for: PVProSystemCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVProSystemBundle: Bundle { Bundle(for: PVProSystemCore.self) }
...
@objc
extension PVProSystemCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVProSystemBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVProSystemBundle }
