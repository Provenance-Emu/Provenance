...
public extension PVBundleFinder {
    static var DolphinCoreModule: Bundle { Bundle.module }
    static var DolphinCoreBundle: Bundle { Bundle(for: PVDolphinCore.self) }
}
#else
public extension PVBundleFinder {
    static var DolphinCoreModule: Bundle { Bundle(for: PVDolphinCore.self) }
}
#endif

@objc
extension PVDolphinCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.DolphinCoreModule }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.DolphinCoreModule }
    ...
    public static var corePlistFromBundle: EmulatorCoreInfoPlist {
        ...
        let options: PropertyListSerialization.ReadOptions = .init()
