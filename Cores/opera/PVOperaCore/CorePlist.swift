...
public extension PVBundleFinder {
    static var OperaModule: Bundle { Bundle.module }
    static var OperaBundle: Bundle { Bundle(for: PVOperaCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVOperaCoreBundle: Bundle { Bundle(for: PVOperaCore.self) }
}
#endif

@objc
extension PVOperaCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVOperaCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVOperaCoreBundle }
