...
public extension PVBundleFinder {
    ...
    static var VirtualJaguarBundle: Bundle { Bundle(for: PVCoreGenesisPlus.self) }
}
#else
public extension PVBundleFinder {
    static var PVCoreGenesisPlusBundle: Bundle { Bundle(for: PVCoreGenesisPlus.self) }
}
#endif

@objc
extension PVCoreGenesisPlus: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVCoreGenesisPlusBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVCoreGenesisPlusBundle }
