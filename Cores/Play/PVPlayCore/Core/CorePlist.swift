...
public extension PVBundleFinder {
    static var PVPlayCoreModule: Bundle { Bundle.module }
    static var PVPlayCoreBundle: Bundle { Bundle(for: PVPlayCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVPlayCoreBundle: Bundle { Bundle(for: PVPlayCore.self) }
...
@objc
extension PVPlayCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { Bundle(for: PVPlayCore.self) }

    @objc
    public override var resourceBundle: Bundle { PVPlayCore.resourceBundle }
