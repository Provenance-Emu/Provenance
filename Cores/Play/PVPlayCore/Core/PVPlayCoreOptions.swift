...
@objc public class PVPlayCoreOptions: NSObject, CoreOptions {
...
@objc public extension PVPlayCoreBridge {
    @objc var resolution: Int{
        PVPlayCore.valueForOption(PVPlayCoreOptions.resolutionOption).asInt ?? 0
    }
    @objc var gs: Int{
        PVPlayCore.valueForOption(PVPlayCoreOptions.gsOption).asInt ?? 0
    }
    @objc var bilinearFiltering: Bool {
        PVPlayCore.valueForOption(PVPlayCoreOptions.forceBilinearFilteringOption).asBool
    }
    @objc var spu: Int{
        PVPlayCore.valueForOption(PVPlayCoreOptions.spuOption).asInt ?? 0
    }
    @objc var fps: Bool {
        PVPlayCore.valueForOption(PVPlayCoreOptions.limitFPSOption).asBool
    }
}
...
@objc public extension PVPlayCoreBridge {
    func parseOptions() {
        ...
        self.volume = NSNumber(value:PVPlayCore.valueForOption(PVPlayCoreOptions.volumeOption).asInt ?? 100).int8Value
    }
}
