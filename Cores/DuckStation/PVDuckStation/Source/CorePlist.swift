...
public extension PVBundleFinder {
    static var PVDuckStationCoreModule: Bundle { Bundle.module }
    static var PVDuckStationCoreBundle: Bundle { Bundle(for: PVDuckStationCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVDuckStationCoreBundle: Bundle { Bundle(for: PVDuckStationCore.self) }
...
@objc
extension PVDuckStationCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { Bundle(for: PVDuckStationCore.self) }

    @objc
    public override var resourceBundle: Bundle { PVDuckStationCore.resourceBundle }
