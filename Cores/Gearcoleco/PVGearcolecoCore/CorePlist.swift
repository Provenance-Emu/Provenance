...
public extension PVBundleFinder {
    static var GearcolecoModule: Bundle { Bundle.module }
    static var GearcolecoBundle: Bundle { Bundle(for: PVGearcolecoCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVGearcolecoCoreBundle: Bundle { Bundle(for: PVGearcolecoCore.self) }
}
#endif

@objc
extension PVGearcolecoCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVGearcolecoCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVGearcolecoCoreBundle }
