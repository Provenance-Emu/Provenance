...
public extension PVBundleFinder {
    static var MelonDSModule: Bundle { Bundle.module }
    static var MelonDSBundle: Bundle { Bundle(for: PVMelonDSCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVMelonDSCoreBundle: Bundle { Bundle(for: PVMelonDSCore.self) }
}
#endif

@objc
extension PVMelonDSCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVMelonDSCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVMelonDSCoreBundle }
