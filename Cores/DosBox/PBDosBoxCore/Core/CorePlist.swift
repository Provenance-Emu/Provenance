...
public extension PVBundleFinder {
    ...
    static var Desmume2015Bundle: Bundle { Bundle(for: PVDosBoxCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVDosBoxCoreBundle: Bundle { Bundle(for: PVDosBoxCore.self) }
}
#endif

@objc
extension PVDosBoxCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVDosBoxCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVDosBoxCoreBundle }
