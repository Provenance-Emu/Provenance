...
public extension PVBundleFinder {
    static var VisualBoyAdvanceModule: Bundle { Bundle.module }
    static var VisualBoyAdvanceBundle: Bundle { Bundle(for: PVVisualBoyAdvanceCore.self) }
}
#else
public extension PVBundleFinder {
    static public var VisualBoyAdvanceBundle: Bundle { Bundle(for: PVVisualBoyAdvanceCore.self) }
}
#endif

@objc
extension PVVisualBoyAdvanceCore: EmulatorCoreInfoPlistProvider {
