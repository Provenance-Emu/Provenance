...
public extension PVBundleFinder {
    static var FreeIntvModule: Bundle { Bundle.module }
    static var FreeIntvBundle: Bundle { Bundle(for: PVFreeIntvEmuCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVFreeIntvCoreBundle: Bundle { Bundle(for: PVFreeIntvCore.self) }
}
#endif

@objc
extension PVFreeIntvCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVFreeIntvCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVFreeIntvCoreBundle }
