...
public extension PVBundleFinder {
    static var PCSXRearmedModule: Bundle { Bundle.module }
    static var PCSXRearmedBundle: Bundle { Bundle(for: PVPCSXRearmedCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVPCSXRearmedCoreBundle: Bundle { Bundle(for: PVPCSXRearmedCore.self) }
}
#endif

@objc
extension PVPCSXRearmedCore: EmulatorCoreInfoPlistProvider {
    ...
    #else
    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVPCSXRearmedCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVPCSXRearmedCoreBundle }
