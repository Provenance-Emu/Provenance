...
- **Portrait controller scaling** — Portrait mode applies `scaleEffect` to visually resize controls while clipping overflow and constraining hit-testing to the allocated frame area, so buttons genuinely shrink or grow at every scale value (#3523)
