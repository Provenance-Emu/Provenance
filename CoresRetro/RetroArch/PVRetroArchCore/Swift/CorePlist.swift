...
public extension PVBundleFinder {
    static var PVRetroArchCoreModule: Bundle { Bundle.module }
    static var PVRetroArchCoreBundle: Bundle { Bundle(for: PVRetroArchCoreCore.self) }
}
#else
public extension PVBundleFinder {
    static var PVRetroArchCoreBundle: Bundle { Bundle(for: PVRetroArchCoreCore.self) }
...
@objc
extension PVRetroArchCoreCore: EmulatorCoreInfoPlistProvider {

    @objc
    public static var resourceBundle: Bundle { PVBundleFinder.PVRetroArchCoreBundle }

    @objc
    public override var resourceBundle: Bundle { PVBundleFinder.PVRetroArchCoreBundle }
    ...
    @objc(corePlist)
    public static var corePlist: EmulatorCoreInfoPlist { corePlistFromBundle }
