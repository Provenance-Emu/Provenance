//
//  PVRetroArchCoreBridge+Controls+Vectrex.m
//  PVRetroArch
//
...
@interface PVRetroArchCoreBridge (VectrexControls) <PVVectrexSystemResponderClient>
@end
...
- (void)didReleaseVectrexButton:(PVVectrexButton)button forPlayer:(NSInteger)player {
    [self handleVextrexButton:button forPlayer:player pressed:false];
}

- (void)handleVextrexButton:(PVVectrexButton)button forPlayer:(NSInteger)player pressed:(BOOL)pressed {
