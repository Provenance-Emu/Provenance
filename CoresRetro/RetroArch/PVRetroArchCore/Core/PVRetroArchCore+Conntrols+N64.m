...
- (void)didMoveN64JoystickDirection:(PVPSXButton)button withValue:(CGFloat)value forPlayer:(NSInteger)player {
    [self handleN64Button:button forPlayer:player pressed:(value != 0) value:value];
}
