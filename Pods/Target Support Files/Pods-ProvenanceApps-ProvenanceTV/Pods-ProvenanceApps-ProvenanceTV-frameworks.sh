...
if [[ "$CONFIGURATION" == "Archive" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PVAtari800-tvOS/PVAtari800.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PVGambatte-tvOS/PVGambatte.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PVPokeMini-tvOS/PVPokeMini.framework"
