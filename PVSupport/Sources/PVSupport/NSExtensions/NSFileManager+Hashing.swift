...
fileprivate let HASH_READ_CHUNK_SIZ = 1024 * 32

@objc
public protocol OEHashingAdditions {
    typealias Hashes = (md5: String, crc32: String)
    func hashFile(atURL url: URL, headerSize: Int = 0) -> Hashes throws
}

public extension OEHashingAdditions {
    func hashFile(atURL url: URL, headerSize: Int = 0) -> Hashes throws {
